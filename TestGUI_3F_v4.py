...
def flow_to_rate_g_l_h(flow_m3h: float) -> float:
...
class App(ctk.CTk):
    ...
    def open_flow_plot(self, fermenter):
        ...
        flow_var = tk.StringVar(value="0.00 m3/h")
        ...
        ax_flow.set_title("Caudal CO2")
        ax_flow.set_ylabel("m3/h")
